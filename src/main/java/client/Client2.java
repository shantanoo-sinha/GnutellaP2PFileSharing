...
public class Client2 implements Serializable {
	 ...
	 */
	public Client2(String id, String peerNetworkTopology) {
		super();
		this.id = id;
//		initServer(this, id, peerNetworkTopology, TTR);
	 ...
	 * @param TTR the ttr
	 */
	private void initServer(Client2 client, String id, String peerNetworkTopology, long TTR) {
		try {
			server = new Server2(client, id, peerNetworkTopology, TTR, rsaKeyPair);
		} catch (Exception e) {
	 ...
	 */
	public void setServer(Server2 server) {
		this.server = server;
	}
	...
	public void registerFiles() {
		...
		new Thread(new DirectoryWatcher2(this)).start();
	...
	public static void main(String[] args) {
		...
		Client2 client = new Client2(id, topology);
