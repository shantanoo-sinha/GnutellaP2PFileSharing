...
cd ..\Client10
START /MAX Client10-linear.bat Pull 50000
echo Client10 started...
timeout /t 2

echo Starting Client 13...
cd ..\Client13
START /MAX Client13-linear.bat Pull 50000
echo Client13 started...
timeout /t 2

echo Starting Client 16...
cd ..\Client16
START /MAX Client16-linear.bat Pull 50000
echo Client16 started...
timeout /t 2

echo Starting Client 19...
cd ..\Client19
START /MAX Client19-linear.bat Pull 50000
echo Client19 started...
timeout /t 2

echo Starting Client 22...
cd ..\Client22
START /MAX Client22-linear.bat Pull 50000
echo Client22 started...
timeout /t 2

echo Starting Client 25...
cd ..\Client25
START /MAX Client25-linear.bat Pull 50000
echo Client25 started...
timeout /t 2

echo Starting Client 28...
cd ..\Client28
START /MAX Client28-linear.bat Pull 50000
